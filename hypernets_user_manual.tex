...
\begin{tabularx}{\textwidth}{|c|X|l|}
    \hline
    \multirow{3}{*} {\includegraphics[scale=.080]{logoHypernet.png}}            
     & Reference    &     \reference            \\
     \cline{2-3}
    \multirow{3}{*} & Version  &  \numVersion   \\
     \cline{2-3}
...
%==============================================================================%
% Chapter Selection:
% \includeonly{mounting_guide, linux_installation}
% \includeonly{hypernets_tools, first_tests, old_version_manual}
% \includeonly{first_tests, annex_config_files}
%==============================================================================%
